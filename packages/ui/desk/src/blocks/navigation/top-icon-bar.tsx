...
export function TopIconBar({ identity, navigationOpen, onToggleNavigation, topology, applications }: { applications?: DeskApplication[]; identity?: MdiUserIdentity; navigationOpen: boolean; onToggleNavigation: () => void; topology?: MdiTopologyAdapter }) {
