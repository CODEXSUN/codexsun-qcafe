...
export function TopIconBar({ navigationOpen, onToggleNavigation, topology, applications }: { applications?: DeskApplication[]; navigationOpen: boolean; onToggleNavigation: () => void; topology?: MdiTopologyAdapter }) {
