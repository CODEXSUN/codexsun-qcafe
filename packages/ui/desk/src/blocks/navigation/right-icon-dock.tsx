...
export function RightIconDock({ propertiesOpen = false, onPropertiesClick, topology }: { propertiesOpen?: boolean; onPropertiesClick?: () => void; topology?: MdiTopologyAdapter }) {
