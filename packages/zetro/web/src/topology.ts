...
export const zetroTopology: InterfaceTopologySection[] = [
  ...
  { id: "05", name: "Project tree", scope: "Workspace drawer", description: "Repository-oriented navigation for core and agent-run surfaces." },
  ...
  { id: "07", name: "Agent selector", scope: "Center workspace", description: "Current sidecar provider and workspace safety mode." },
  ...
  { id: "10", name: "Message composer", scope: "Conversation canvas", description: "Input area for the selected specialist agent." },
