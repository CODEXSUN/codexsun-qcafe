...
export class WorkspaceStore {
  ...
  constructor(file: string, private readonly defaultSettings: ZetroSettings) {
  ...
  saveSettings(settings: ZetroSettings) { this.save("zetro_settings", "workspace", settings); }
