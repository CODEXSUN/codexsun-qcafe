...
- Bumped the workspace version to 1.1.0.

## v-1.0.10

### [v 1.0.10] 2026-09-06 11:07 p.m. - Show Q Cafe update status and installed version
...
- Bumped the workspace version to 1.0.10.
...
### [v 1.0.8] 2026-09-06 10:25 p.m. - Q Cafe installer process shutdown
...
- Bumped the workspace version to 1.0.8.

## v-1.0.7

### [v 1.0.7] 2026-09-06 10:09 p.m. - Q Cafe Windows update check repair
...
- Bumped the workspace version to 1.0.7.

## v-1.0.6

### [v 1.0.6] 2026-09-06 9:48 p.m. - Q Cafe first setup data controls
...
- Bumped the workspace version to 1.0.6.
...
### [v 1.0.4] 2026-09-06 8:58 p.m. - Package Q Cafe startup migration repair
...
- Bumped the workspace version to 1.0.4.
...
### [v 0.1.29] 2026-09-06 12:47 p.m. - Show installed release version in context dock
...
- Bumped the workspace version to 0.1.29.
...
### [v 0.1.27] 2026-09-06 12:20 p.m. - Fix Orship health probe
...
- Bumped the workspace version to 0.1.27.
...
### [v 0.1.25] 2026-09-06 12:06 p.m. - Orship visual release operations
...
- Bumped the workspace version to 0.1.25.

## v-0.1.24

### [v 0.1.24] 2026-09-06 10:51 a.m. - Reliable cloud release-state updates
...
- Bumped the workspace version to 0.1.24.
