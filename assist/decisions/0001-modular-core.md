# Decision 0001: Modular core

Status: accepted

## Decision

Use one npm monorepo and a modular TypeScript core.
...
Use Node.js for orchestration, React for the core, Python for supported workloads, and Rust for host adapters.
