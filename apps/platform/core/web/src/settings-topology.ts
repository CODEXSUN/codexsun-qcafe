...
export const settingsTopology: InterfaceTopologySection[] = [
  ...
  { id: "s2.1", technicalName: "settings.sideCar.content", name: "Settings navigation", scope: "Platform Settings", description: "List Applications, Architecture, Connections, Identity, and Runtime pages." },
  ...
  { id: "s2.1.2", technicalName: "settings.sideCar.architectureLink", name: "Architecture settings link", scope: "Platform Settings", description: "Open project architecture and structures registry." },
  { id: "s2.1.3", technicalName: "settings.sideCar.connectionsLink", name: "Connections settings link", scope: "Platform Settings", description: "Open local module connection settings." },
  { id: "s2.1.4", technicalName: "settings.sideCar.identityLink", name: "Identity settings link", scope: "Platform Settings", description: "Open identity settings." },
  { id: "s2.1.5", technicalName: "settings.sideCar.runtimeLink", name: "Runtime settings link", scope: "Platform Settings", description: "Open runtime settings." },
