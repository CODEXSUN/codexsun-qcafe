...
export const settingsTopology: InterfaceTopologySection[] = [
  ...
  { id: "s2.1", technicalName: "settings.sideCar.content", name: "Settings navigation", scope: "Platform Settings", description: "List Applications, Identity, and Runtime pages." },
  ...
  { id: "s2.1.2", technicalName: "settings.sideCar.identityLink", name: "Identity settings link", scope: "Platform Settings", description: "Open identity settings." },
  { id: "s2.1.3", technicalName: "settings.sideCar.runtimeLink", name: "Runtime settings link", scope: "Platform Settings", description: "Open runtime settings." },
