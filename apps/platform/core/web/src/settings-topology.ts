...
export const settingsTopology: InterfaceTopologySection[] = [
  ...
  { id: "s2.1.2", technicalName: "settings.sideCar.connectionsLink", name: "Connections settings link", scope: "Platform Settings", description: "Open local module connection settings." },
  { id: "s2.1.3", technicalName: "settings.sideCar.identityLink", name: "Identity settings link", scope: "Platform Settings", description: "Open identity settings." },
  { id: "s2.1.4", technicalName: "settings.sideCar.runtimeLink", name: "Runtime settings link", scope: "Platform Settings", description: "Open runtime settings." },
