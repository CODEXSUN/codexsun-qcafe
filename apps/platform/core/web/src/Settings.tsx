import { Boxes, CheckCircle2, Settings2 } from "lucide-react";
...
export function createSettingsWorkspace(applications: Application[]): MdiWorkspaceAddon {
  return {
    ...
    label: "Settings",
    placement: "utility",
    navigation: { id: "settings", hideSearch: true, searchPlaceholder: "Search settings", groups: [{ defaultOpen: true, id: "platform", items: [{ id: "applications", title: "Applications" }, { id: "identity", title: "Identity" }, { id: "runtime", title: "Runtime" }], title: "Platform" }] },
