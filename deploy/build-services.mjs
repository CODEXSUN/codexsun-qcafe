...
for (const [name, entry] of Object.entries({ platform: "apps/platform/core/api/src/server.ts", zetro: "packages/zetro/api/src/server.ts", chat: "packages/chat/api/src/cloud-server.ts", docs: "apps/docs/api/src/server.mjs", orship: "packages/orship/api/src/server.ts" })) {
